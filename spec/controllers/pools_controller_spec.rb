  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved pool as @pool" do
        ...
        post :create, {:pool => { "name" => "invalid value" }}, valid_session
        assigns(:pool).should be_a_new(Pool)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested pool" do
        ...
        Pool.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => pool.to_param, :pool => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the pool as @pool" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Pool.any_instance.stub(:save).and_return(false)
        put :update, {:id => pool.to_param, :pool => { "name" => "invalid value" }}, valid_session
        assigns(:pool).should eq(pool)
      end
